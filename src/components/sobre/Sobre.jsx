  ...
  return (
    <div className='div-sobre' id='sobre'>
      ...
      <div className='div-text-sobre'>
        <h1>SOBRE MIM</h1>
        <p>Sou um desenvolvedor front end com 21 anos de idade e um ano de experiência construindo soluções digitais como freelancer. Desde que entrei no mundo da tecnologia, descobri um universo fascinante e desafiador que me permitiu mergulhar de cabeça na criação de aplicativos web dinâmicos e inovadores.</p>
